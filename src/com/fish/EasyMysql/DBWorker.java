...
public final class DBWorker
{
     ...
     * @return 返回得到的 SQL 语句
     * */
    private static String getSqlOrder()
    {
        StringBuilder sql = new StringBuilder();
        try
        {
            BufferedReader br = new BufferedReader(new FileReader(new File("works.in")));
    ...
    /**
     * 从数据库修改一行数据
     * @param tableName 要被修改数据的表名
     * @param columnName 要被修改的列名称
     * @param newValue 新设定的值
     * @param oldValue 旧的值
     *                 示例：
